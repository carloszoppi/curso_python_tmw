    ...
    if numero_usuario.isdigit():
        ...
        if 1 <= numero_usuario <= 15:
            ...
            if numero_usuario == st.session_state.numero_sorteado:
                ...
                if numero_usuario > st.session_state.numero_sorteado:
                    st.warning(f"Número digitado é maior que o sorteado. Tente novamente")
                elif numero_usuario < st.session_state.numero_sorteado:
                    st.warning(f"Número digitado é menor que o número sorteado. Tente novamente.")
